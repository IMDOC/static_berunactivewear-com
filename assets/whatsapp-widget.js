(function() {
  ...
  const defaultConfig = {
    ...
    contacts: [
      {
        ...
        phone: '8613800007212',
        avatar: '',
        message: 'Hi, I\'m interested in your custom activewear OEM/ODM services.'
      }
    ],
    ...
    popupTitle: 'How can we help you?',

    welcomeMessage: 'Choose a contact below to start chatting',
  ...
  function createWidget() {
    ...
    container.innerHTML = `
      <button class="wa-widget-button" id="waWidgetBtn" aria-label="Open WhatsApp chat">
      ...
      <div class="wa-widget-popup" id="waWidgetPopup">
        <div class="wa-popup-header">
          ...
          <button class="wa-popup-close" id="waPopupClose" aria-label="Close popup">×</button>
        </div>
